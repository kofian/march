...
function EuroGoBar() {
  return (
    ...
    <Grid container justify="center" spacing={16}>
     <Grid item xs={8}>
       <FormLabel style={styles.control}>Every Hour</FormLabel>
    ...
    <FormLabel style={styles.control}>Numbers from Tue 26 June</FormLabel>
        ...
        <Divider light/><br/>
        <Typography style={{color: cyan800}} variant="body2" gutterBottom>» EuroMillions GO! Results & Prizes</Typography>
        <Typography style={{color: cyan800}} variant="body2" gutterBottom>» EuroMillions GO! Help & FAQs</Typography>
        <Divider light/><br/>
        <Grid item xs={12}>
...
export default withTheme()(EuroGoBar);