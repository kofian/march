...
function MegaBar() {
  return (
    ...
    <Grid container justify="center" spacing={16}>
     <Grid item xs={8}>
       <FormLabel style={styles.control}>1 day 10 hours remaining</FormLabel>
        ...
        <Grid item xs={4}>
          <img src={require('../../../images/lt-megaMillions-f64957c20d2af511.png')} width="50" height="50"/>
        </Grid>
    </Grid>
    <Divider light/>
    <FormLabel style={styles.control}>Numbers from Tue 26 June</FormLabel>
        ...
        <Divider light/><br/>
        <Typography style={{color: cyan800}} variant="body2" gutterBottom>» MegaMillions Results & Prizes</Typography>
        <Typography style={{color: cyan800}} variant="body2" gutterBottom>» MegaMillions Help & FAQs</Typography>
        <Divider light/><br/>
        <Grid item xs={12}>
...
export default withTheme()(MegaBar);