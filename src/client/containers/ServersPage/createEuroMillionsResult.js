...
export class EuroMillionsResult extends React.Component {
    constructor(...args) {
    super(...args);
    this.state =  {
      jackpot_0: 0, 
    ...
    this._createEuroMillionsResult = this._createEuroMillionsResult.bind(this);
   }
   ...
   _createEuroMillionsResult(){
    ...
    console.log(values);
      this.props.actions.createEuroMillionsResult(values);
   }
   ...
   return(
    <form style={{display: 'flex',flexWrap: 'wrap',justify: "center", alignItems: "center"}} noValidate autoComplete="off">
     <Grid container className={classes.root} spacing={16} justify="center">
       ...
       onClick={this._createEuroMillionsResult}>
        Create EuroMillions Result
...
export default connect(null, mapDispatchToProps)(withStyles(styles)(EuroMillionsResult));
