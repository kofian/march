...
export default class EuroMillionsBar extends React.Component {
  static propTypes = {
    ...
    return (
      <Toolbar>
        <ToolbarGroup style={{paddingLeft: 20}} firstChild>
          ...
          <NavigationButton to="/megamillions" label="EuroMillions" exact />
          <NavigationButton to="/megamillions" label="EuroMillionsGo!" exact />
        </ToolbarGroup>
        <ToolbarGroup>
          <TextField
            hintText="Filter"
